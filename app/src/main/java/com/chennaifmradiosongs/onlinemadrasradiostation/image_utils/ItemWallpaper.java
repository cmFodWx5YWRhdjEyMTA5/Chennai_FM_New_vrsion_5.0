...
public class ItemWallpaper {
    ...
    public ItemWallpaper(String id, String cId,
                         String cName, String image,
                         String imageThumb, String totalViews,
                         String totalRate, String averageRate,
                         String totalDownloads, String tags) {
        this.id = id;
        this.CId = cId;
        this.CName = cName;
        this.image = image;

...
public class AdtsReaderTest extends TestCase {
  ...
  public void testSkipToNextSample() {
  ...
  public void testSkipToNextSampleResetsState() {
  ...
  public void testNotEnoughDataForIdentifier() {
    feedLimited(3 - 1);
    assertSampleCounts(0, 0);
  }

  public void testNotEnoughDataForHeader() {
    feedLimited(10 - 1);
    assertSampleCounts(0, 0);
  }

  public void testNotEnoughDataForWholeId3Packet() {
    feedLimited(ID3_DATA_1.length - 1);
    assertSampleCounts(0, 0);
  }

  public void testConsumeWholeId3Packet() {
    feedLimited(ID3_DATA_1.length);
    assertSampleCounts(1, 0);
    id3Output.assertSample(0, ID3_DATA_1, 0, C.SAMPLE_FLAG_SYNC, null);
  }

  public void testMultiId3Packet() {
    feedLimited(ID3_DATA_1.length + ID3_DATA_2.length - 1);
    assertSampleCounts(1, 0);
    id3Output.assertSample(0, ID3_DATA_1, 0, C.SAMPLE_FLAG_SYNC, null);
  }

  public void testMultiId3PacketConsumed() {
  ...
  public void testMultiPacketConsumed() {
    for (int i = 0; i < 10; i++) {
      data.setPosition(0);

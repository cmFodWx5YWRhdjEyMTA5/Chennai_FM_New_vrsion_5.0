...
public final class WebvttCueParserTest extends InstrumentationTestCase {
  ...
  public void testParseStrictValidClassesAndTrailingTokens() {
  ...
  public void testParseStrictValidUnsupportedTagsStrippedOut() {
  ...
  public void testParseWellFormedUnclosedEndAtCueEnd() {
  ...
  public void testParseWellFormedUnclosedEndAtParent() {
  ...
  public void testParseMalformedNestedElements() {
  ...
  public void testParseCloseNonExistingTag() {
  ...
  public void testParseEmptyTagName() {
  ...
  public void testParseCornerCases() {
    Spanned text = parseCueText(">");
    assertEquals(">", text.toString());
